...
const handleSubmit=(e)=>{
  e.preventDefault()
  dispatch(Login({Nom,Mot},navigate))
  navigate('/login')
}
  ...
  <Form.Group className="mb-3" controlId="formBasicText">
    ...
    <Form.Control type="text" placeholder="Mot" onChange={e=>setMot(e.target.value)}value={Mot}/>
  </Form.Group>
  ...
  <a href="http://localhost:3000/inscrire">s'inscrire</a>
</Form>
